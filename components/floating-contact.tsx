...
export default function FloatingContact() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end pointer-events-none">
      {/* Expanded Menu */}
      <div 
        className={`pointer-events-auto bg-white/90 backdrop-blur-xl border border-gray-200/50 shadow-2xl rounded-2xl p-4 mb-4 w-[calc(100vw-3rem)] max-w-[18rem] transition-all duration-300 origin-bottom-right ${
      ...
      <button 
        ...
        className="pointer-events-auto w-16 h-16 bg-accent hover:bg-accent/90 text-accent-foreground rounded-full shadow-2xl flex items-center justify-center hover:scale-105 smooth-transition relative group"
      >
